...
Revision ID: e5bff66306c5
Revises: 77b8414d2ed5
Create Date: 2019-10-28 18:53:02.637564
...
revision = 'e5bff66306c5'
down_revision = '77b8414d2ed5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('actors', sa.String(length=1500), nullable=False),
